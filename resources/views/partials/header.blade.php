...
<header class="site-header">
            ...
            <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                ...
                <div class="menu-navigation navbar-collapse collapse">
                    ...
                    <ul class="menu-navigation__list nav navbar-nav">
                        <li class="current"><a href="#l">Home</a></li>
                        <li><a href="#">About us</a></li>
                        <li><a href="#">Fleet </a>
                            {{--<ul class="sub-menu dropdown-menu">--}}
                                {{--<li><a href="fleet.html">Cars </a>--}}
                                    {{--<ul class="dropdown-menu">--}}
                                        {{--<li><a href="#">Executive Sedans </a>--}}
                                            {{--<ul class="dropdown-menu">--}}
    ...
    <div class="header-container_wrap container">
        <div class="header-container__flex">
            <div class="logo">
                <a href="#"><img src="assets/images/logo.jpg" alt="Rent a car"></a>
            </div>
            <div class="social-list">
                <span class="social-list__text">Find us here:</span>
                <ul class="social-list__icons">
            ...
            <div class="container">
                ...
                <div class="menu-navigation navbar-collapse collapse">
                    ...
                    <ul class="menu-navigation__list nav navbar-nav">
                        ...
                        <li><a href="#" data-hover="Fleet">Fleet </a>
                            {{--<ul class="sub-menu dropdown-menu">--}}
                                {{--<li><a href="fleet.html">Cars </a>--}}
                                    {{--<ul class="dropdown-menu">--}}
                                        {{--<li><a href="#">Executive Sedans </a>--}}
                        ...
                        <li><a href="#" data-hover="Services">Services </a>
                            {{--<ul class="sub-menu dropdown-menu">--}}
                                {{--<li><a href="services-post.html">24 Hour Airport Services</a></li>--}}
                                {{--<li><a href="services.html">Business Travel</a></li>--}}
                                {{--<li><a href="services.html">Corporate</a></li>--}}
                        ...
                        <li><a href="#" data-hover="Rates">Rates</a></li>
                        <li><a href="#" data-hover="Our drivers">Our drivers</a></li>
                        <li><a href="#" data-hover="Testimonials">Tips</a></li>
                        <li><a href="#" data-hover="Blog">Blog </a>
                            {{--<ul class="sub-menu dropdown-menu">--}}
                                {{--<li><a href="blog.html">Blog list</a></li>--}}
                                {{--<li><a href="blog-masonry.html">Masonry layout</a></li>--}}
                                {{--<li><a href="single-post.html">Single Post</a></li>--}}
