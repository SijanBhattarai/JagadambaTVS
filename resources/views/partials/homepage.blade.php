...
<main id="page-content">
    ...
    <div class="slider-wrapper theme-default">
        <div id="slider" class="nivoSlider">
            <img src="assets/images/slider/newslider1.jpg" title="#htmlcaption1" data-thumb="assets/images/slider/slide_1.jpg" alt="" />
            <img src="assets/images/slider/newslider2.jpg" title="#htmlcaption2" data-thumb="assets/images/slider/slide_2.jpg" alt="" />
            <img src="assets/images/slider/newslider3.jpg" title="#htmlcaption3" data-thumb="assets/images/slider/slide_3.jpg" alt="" />
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="post-column">
                            <figure class="thumbnail"><img src="assets/images/twowheeler.jpg" alt=""></figure>
                            <div class="post-column__content">
                                <h3>Two Wheelers</h3>
                                <span class="text-link">Two Wheeler Vehicles</span>
                    ...
                    <div class="swiper-slide">
                        <div class="post-column">
                            <figure class="thumbnail"><img src="assets/images/threewheeler.jpg" alt=""></figure>
                            <div class="post-column__content">
                                <h3>Three Wheelers</h3>
                                <span class="text-link">Three Wheeler Vehicles</span>
                                <a href="#" class="btn btn__marker"><i class="icon-arrows"></i></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="post-column">
                            <figure class="thumbnail"><img src="assets/images/heavyequipment.jpg" alt=""></figure>
                            <div class="post-column__content">
                                <h3>Heavy Equipments</h3>
                                <span class="text-link">Heavy Equipments</span>
                                <a href="#" class="btn btn__marker"><i class="icon-arrows"></i></a>
                            </div>
                        </div>
                    </div>
